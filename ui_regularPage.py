...
################################################################################
## Form generated from reading UI file 'regularPageumttjq.ui'
##
...
"}")
        ...
        sizePolicy4.setHeightForWidth(self.StartButtonsecond.sizePolicy().hasHeightForWidth())
        self.StartButtonsecond.setSizePolicy(sizePolicy4)
        ...
        font3.setBold(False)
        font3.setWeight(50)
        self.StartButtonsecond.setFont(font3)
...
"}")
        ...
        sizePolicy5.setHeightForWidth(self.AddUrgentMeeting.sizePolicy().hasHeightForWidth())
        self.AddUrgentMeeting.setSizePolicy(sizePolicy5)
        self.AddUrgentMeeting.setMinimumSize(QSize(131, 30))
        self.AddUrgentMeeting.setMaximumSize(QSize(200, 20))
        font4 = QFont()
        font4.setPointSize(11)
        self.AddUrgentMeeting.setFont(font4)
...
"}")
        ...
        sizePolicy6.setVerticalStretch(21)
        sizePolicy6.setHeightForWidth(self.UrgentMeeting.sizePolicy().hasHeightForWidth())
        self.UrgentMeeting.setSizePolicy(sizePolicy6)
        self.UrgentMeeting.setMinimumSize(QSize(191, 27))
        self.UrgentMeeting.setMaximumSize(QSize(16777215, 20))
        font5 = QFont()
        font5.setPointSize(9)
        self.UrgentMeeting.setFont(font5)
...
"")
        ...
        sizePolicy5.setHeightForWidth(self.UrgentMeetingStartBtn.sizePolicy().hasHeightForWidth())
        self.UrgentMeetingStartBtn.setSizePolicy(sizePolicy5)
        self.UrgentMeetingStartBtn.setMinimumSize(QSize(0, 29))
        self.UrgentMeetingStartBtn.setMaximumSize(QSize(16777215, 20))
        font6 = QFont()
        font6.setPointSize(10)
        self.UrgentMeetingStartBtn.setFont(font6)
...
"}")
        ...
        sizePolicy7.setHeightForWidth(self.ChangeEmailPass.sizePolicy().hasHeightForWidth())
        self.ChangeEmailPass.setSizePolicy(sizePolicy7)
        ...
        font7.setBold(False)
        font7.setWeight(50)
        self.ChangeEmailPass.setFont(font7)
...
"}")
        ...
        self.ClearSavedData.setFont(font7)
...
"}")
        ...
        self.ContactDeveloper.setFont(font7)
...
"color: rgba(227, 227, 227, 255);")
        ...
        font10.setBold(True)
        font10.setWeight(75)
        self.Description.setFont(font10)
...
"background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:1, stop:0.00568182 rgba(116, 255, 54, 180), stop:1 rgba(255, 170, 0, 150));")
        ...
        self.Description_3.setFont(font10)
